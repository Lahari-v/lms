    ...
    <div className='md:px-36 px-8 pt-10'>
      ...
      <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10'>
        <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left max-sm:hidden'>
          <tr>
            <th className='px-4 py-3 font-semibld truncate'>Course</th>
            <th className='px-4 py-3 font-semibld truncate'>Duration</th>
            <th className='px-4 py-3 font-semibld truncate'>Completed</th>
            <th className='px-4 py-3 font-semibld truncate'>Status</th>
          </tr>
        </thead>
          ...
          {enrolledCourses.map((course, index)=>(
            <tr key={index} className='border-b border-gray-500/20'>
              ...
              <td className='px-4 py-3 max-sm:hidden'>
                {humanizeDuration(calculateCourseDuration(course), {
              ...
              <td className='px-4 oy-3 max-sm:text-right'>
