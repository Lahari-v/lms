  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>
        Discover flexible learning designed for your schedule. Our expert-led courses, engaging content, <br/>and practical projects help you upskill and succeed — on your terms.
      </p>
